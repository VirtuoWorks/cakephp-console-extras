...
<?php
    ...
    echo '<head>';
        ...
        echo $this->Html->meta('description', 'virtuoworks app');
        echo $this->Html->meta('keywords', 'virtuoworks app');
        echo $this->Html->meta(array('name' => 'author',  'content' => 'VirtuoWorks App'));
        echo $this->Html->meta(array('name' => 'publisher',  'content' => 'VirtuoWorks App'));
        ...
        echo '<div id="container" class="container_16">';
            ...
            echo '<div id="footer" class="grid_16">';
                echo '<div class="box box-credits">';
                    echo '<p>';
                        echo __d('default',  'Website made by ');
                        echo $this->Html->link(__d('default',  'VirtuoWorks App') . ' ' .
                                $this->Html->image('virtuoworks/15x15-logo-virtuoworks.png',  array(
                                    'title' =>    __d('default',  'VirtuoWorks App'), 
                                    'alt'=> __d('default',  'VirtuoWorks App'), 
                               )), 
